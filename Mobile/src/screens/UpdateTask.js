...
import { FetchTaskRequest, UpdateTaskRequest } from '../actions/taskActions'
...
const UpdateTask = (props) => {
    ...
    const _createTask = () => {
        ...
        Alert.alert('Update this task', 'Are you sure to update this task?', [
            {
                text: 'OK',
                onPress: () => {
                    const task = {
                    ...
                    UpdateTaskRequest(updateTask.id, task)
                    goBack()
                    navigate('MyTask')
                }
            }, {
